...
if [ "$VERSION" = "" ]; then
	...
	VERSION_DEB="$NUMBER_RELEASE-$date_AJD~ppa0"
	VERSION_DEB_PG="$NUMBER_RELEASE_PG-$date_AJD~ppa0"
elif [ "$VERSION" = "CD" ]; then
	VERSION="$NUMBER_RELEASE-0ubuntu1"
	VERSION_PG="$NUMBER_RELEASE_PG-0ubuntu1"
